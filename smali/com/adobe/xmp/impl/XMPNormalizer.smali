...
.method private static migrateAudioCopyright(Lcom/adobe/xmp/XMPMeta;Lcom/adobe/xmp/impl/XMPNode;)V
    ...
    .end local v20    # "lfPos":I
    .end local v21    # "xdIndex":I
    :cond_1
    :goto_0
    ...
    .local v19, "e":Lcom/adobe/xmp/XMPException;
    goto :goto_1

    .line 640
    .end local v19    # "e":Lcom/adobe/xmp/XMPException;
    .restart local v6    # "dmValue":Ljava/lang/String;
    .restart local v14    # "dcRightsArray":Lcom/adobe/xmp/impl/XMPNode;
    .restart local v15    # "dcSchema":Lcom/adobe/xmp/impl/XMPNode;
    ...
    .restart local v18    # "doubleLF":Ljava/lang/String;
    .restart local v20    # "lfPos":I
    .restart local v21    # "xdIndex":I
    :cond_3
...
.method private static moveExplicitAliases(Lcom/adobe/xmp/impl/XMPNode;Lcom/adobe/xmp/options/ParseOptions;)V
    ...
    .line 384
    .restart local v5    # "itemNode":Lcom/adobe/xmp/impl/XMPNode;
    :cond_8
    ...
    .end local v6    # "propertyIt":Ljava/util/Iterator;
    :cond_c
    return-void
.end method
...
.method private static normalizeDCArrays(Lcom/adobe/xmp/impl/XMPNode;)V
    ...
    invoke-direct {v4, v5, v6, v8}, Lcom/adobe/xmp/impl/XMPNode;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/adobe/xmp/options/PropertyOptions;)V
...
.method private static repairAltText(Lcom/adobe/xmp/impl/XMPNode;)V
    ...
    .line 242
    .end local v0    # "childValue":Ljava/lang/String;
    .end local v1    # "currChild":Lcom/adobe/xmp/impl/XMPNode;
...
.method private static touchUpDataModel(Lcom/adobe/xmp/impl/XMPMetaImpl;)V
    ...
    const-string/jumbo v5, "http://purl.org/dc/elements/1.1/"
    ...
    const-string/jumbo v4, "http://purl.org/dc/elements/1.1/"
    ...
    .line 141
    :cond_1
    const-string/jumbo v4, "http://ns.adobe.com/exif/1.0/"
    ...
    .line 145
    const-string/jumbo v4, "exif:UserComment"
    ...
    :cond_2
    const-string/jumbo v4, "http://ns.adobe.com/xmp/1.0/DynamicMedia/"
    ...
    :cond_3
    const-string/jumbo v4, "http://ns.adobe.com/xap/1.0/rights/"
