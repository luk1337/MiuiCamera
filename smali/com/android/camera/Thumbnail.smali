...
.method public static getLastThumbnailFromContentResolver(Landroid/content/ContentResolver;[Lcom/android/camera/Thumbnail;Landroid/net/Uri;)I
    ...
    iget-wide v6, v3, Lcom/android/camera/Thumbnail$Media;->dateTaken:J
    ...
    iget-object v4, v1, Lcom/android/camera/Thumbnail$Media;->uri:Landroid/net/Uri;
    ...
    .line 232
    :cond_2
    iget-wide v4, v1, Lcom/android/camera/Thumbnail$Media;->id:J

    invoke-static {p0, v4, v5, v9, v8}, Landroid/provider/MediaStore$Images$Thumbnails;->getThumbnail(Landroid/content/ContentResolver;JILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 236
    iget-object v4, v1, Lcom/android/camera/Thumbnail$Media;->path:Ljava/lang/String;

    invoke-static {v4, v9}, Landroid/media/ThumbnailUtils;->createImageThumbnail(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v4, p0}, Lcom/android/camera/Util;->isUriValid(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    invoke-static {v4, v0, v5, v10}, Lcom/android/camera/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/Thumbnail;
    ...
    .line 243
    :cond_5
    iget-wide v4, v3, Lcom/android/camera/Thumbnail$Media;->id:J

    invoke-static {p0, v4, v5, v9, v8}, Landroid/provider/MediaStore$Video$Thumbnails;->getThumbnail(Landroid/content/ContentResolver;JILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 247
    iget-object v4, v3, Lcom/android/camera/Thumbnail$Media;->path:Ljava/lang/String;

    invoke-static {v4, v9}, Landroid/media/ThumbnailUtils;->createVideoThumbnail(Ljava/lang/String;I)Landroid/graphics/Bitmap;
